...
CHECKPOINT =  "./lightning_logs/relaxml-shelltgt-si/version_2/checkpoints/last.ckpt" #"./lightning_logs/relaxml-sio2-polymorph/version_1/checkpoints/last.ckpt" #

# Path to either a single .npz file or a directory of .npz files.
TARGET =  "./data/multi_species_v1/Si3N4_trajectories/" #"./data/sio2_polymorphs_v1/SiO2/coesite_trajectories" #
...
def main() -> None:
    ...
    if SAVE_PLOTS:
        if PLOT_DIR is None:
            ...
            plot_dir = base / "evaluation_plots_shelltgt"
        else:
